...
const Features2 = () => {
    ...
    const [featuresTab, setFeaturesTab] = useState('board');

    const handleFeatures = (value) => {
        setFeaturesTab(value);
    }
    return (
        <div className='relative flex flex-col gap-5 items-center mt-[120px] w-[70%] mx-auto'>
            <h2>Powerfull building blocks</h2>

            <div className='relative flex flex-col gap-5 w-full bg-[#F6F5F4] rounded-2xl p-[30px] '>
                <img src='https://www.notion.so/cdn-cgi/image/format=auto,width=640,quality=100/front-static/shared/illustrations/blocks/topPeekI.png' className='w-[200px] absolute -top-[122px] object-cover' />

                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 64 64"
                    width="1.8em"
                    style={{ fill: '', color: '#00a1befa' }}
                >
                    <path
                ...
                <div className='!text-lg w-[55%]'>
                    <p className=' font-semibold'>Visualize, filter & sort any way you want</p>
                    <p>Show only tasks assigned to you, or items marked as urgent. Break down any project in the way that’s most helpful to you.</p>
                </div>
                <div className='w-full rounded-2xl overflow-hidden '>
                    {
                        featuresTab === 'board' ?
                            ...
                            : featuresTab === 'table' ?
                                <img src={table} />
                                : featuresTab === 'timeline' ?
                                    <img src={timeline} />
                                    : featuresTab === 'calender' ?
                                        <img src={calender} />
                                        : featuresTab === 'gallery' ?
                                            <img src={gallery} />
                                            : featuresTab === 'list' ?
                                                <img src="https://www.notion.so/cdn-cgi/image/format=webp,width=3840/front-static/pages/home/building-blocks/list.png" />
                                                : null
                    }
                </div>
                ...
                <div className='flex gap-5 w-full justify-center'>
                    ...
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('board')}>Board</button>
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('table')}>Table</button>
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('timeline')}>Timeline</button>
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('calender')}>Calender</button>
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('gallery')}>Gallery</button>
                    <button className='bg-transparent border-[#cbcbcb] rounded-lg px-2 py-1 border-[1px] hover:bg-[#e7e7e7]' onClick={() => handleFeatures('list')}>List</button>
            ...
            <div className='flex gap-10'>
                ...
                <div className=' bg-gray-200 pl-[30px] pt-[30px] flex flex-col gap-5 border-[1px] border-gray-200 shadow-sm rounded-2xl overflow-hidden'>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 64 64"
                        width="3.2em"
                    ...
                    <p className=' font-semibold'>Customize the info you track</p>
                    <p>Create your own labels, tags, owners, and more, so everyone has context and everything stays organized.</p>
                </div>

                <div className='w-full flex justify-end items-end '>
                    <img src='https://www.notion.so/cdn-cgi/image/format=webp,width=2048/front-static/pages/home/customize-info.png' className=' scale-35 object-cover'/>
                </div>
                </div>
                ...
                <div className='w-full flex justify-end items-end '>
                    <img src='https://www.notion.so/cdn-cgi/image/format=webp,width=2048/front-static/pages/home/build-any-page-communicate-any-idea.png' className=' scale-35 object-cover'/>
                </div>
                </div>
